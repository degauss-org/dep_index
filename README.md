...
```sh
docker run --rm -v $PWD:/tmp ghcr.io/degauss-org/dep_index:0.2.2 my_address_file_geocoded.csv
```

will produce `my_address_file_geocoded_dep_index_0.2.2.csv` with added columns:
